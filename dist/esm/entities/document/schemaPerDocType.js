...
import { instagramCaptionSchema, instagramSponsoredAdSchema, instagramPostIdeaSchema, instagramBioDescriptionSchema, instagramStoryIdeaSchema, instagramReelIdeaSchema, instagramReelScriptSchema, linkedInPostCaptionSchema, linkedInPostIdeaSchema, linkedInPageAboutSchema, facebookPostCaptionSchema, facebookPostIdeaSchema, facebookPageAboutSchema, twitterTwitSchema, threadsTwitSchema, cartAbandonmentEmailSchema, trafficEmailSchema, pushNotificationSchema, newsletterEmailSchema, productUpdateEmailSchema, welcomeEmailSchema, emailContentSchema, flashSaleSmsSchema, notificationSmsSchema, smsContentSchema, smsIdeaSchema, googleAdsKeywordsSchema, googleAdsIdeaSchema, socialAdSchema, emailAdPromoSchema, searchAdSchema, websiteAboutSchema, websiteFaqSchema, websiteTestimonialSchema, websiteProductDescriptionSchema, articleSchema, blogPostOpinionSchema, blogPostTipsSchema, blogPostGuideSchema, blogPostComparisonSchema, blogPostCaseStudySchema, blogPostGeneralSchema, linkedinSponsoredAdSchema, facebookSponsoredAdSchema, } from "./documentEntity";
export const schemaPerDocType = {
    ...
    [DocumentEntityType.WEBSITE_PRODUCT_DESCRIPTION]: websiteProductDescriptionSchema,
